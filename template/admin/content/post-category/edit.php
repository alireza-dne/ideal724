            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش اصلاح دسته بندی پست ها</h3>
                            <h6 class="mb-5"></h6>

                        </div>

                        <div>
                            <a href="<?= url('admin/content/post-category') ?>"
                    ...
                    <div class="body-content">
                        <form class="row g-3"
                            action="<?= url('admin/content/post-category/update/' . $category['id']) ?>" method="post"
                            ...
                            <div class="mb-3 col-md-6"><img class="edit-image" src="<?= asset($category['image']) ?>"
                                    alt="edit-image">
                            </div>
                            <div class="col-md-12">
                                ...
                                <select class="form-select" name="status" id="status">
                                    ...
                                    <option value="0" <?= $category['status'] == 2 ? 'selected' : '' ?>>غیر فعال
                                    </option>
                                </select>
                            </div>
                            <div class="col-12">
