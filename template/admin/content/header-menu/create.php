            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش ایجاد منو header جدید</h3>
                            <h6 class="mb-5"></h6>

                        </div>

                        <div>
                            <a href="<?= url('admin/content/header-menu') ?>" class="btn btn-outline-warning">بازگشت</a>
                        </div>
                    </div>

                    <div class="body-content">
                        <form class="row g-3" action="<?= url('admin/content/header-menu/store') ?>" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="parent_id" id="parent_id">
                                    ...
                                    <?php foreach ($headerMenus as $headerMenu) {
                                        if ($headerMenu['parent_id'] == null) { ?>
                                    <option value="<?= $headerMenu['id'] ?>"
                                        <?= old('parent_id') == $headerMenu['id'] ? 'selected' : '' ?>>
                                        <?= $headerMenu['name'] ?>
                                    </option>
                                    <?php }
                                    } ?>
