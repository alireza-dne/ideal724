            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش اصلاح منو header</h3>
                            <h6 class="mb-5"></h6>
                    ...
                    <div class="body-content">
                        <form class="row g-3"
                            action="<?= url('admin/content/header-menu/update/' . $headerMenu['id']) ?>" method="post">


                            <div class="col-md-6">
                                <label for="name" class="form-label">نام</label>
                                <input type="text" name="name" class="form-control" id="name"
                                    value="<?= $headerMenu['name'] ?>">
                            </div>

                            <div class="col-md-6">
                                <label for="row" class="form-label">ردیف</label>
                                <input type="text" name="row" class="form-control" id="row"
                                    value="<?= $headerMenu['row'] ?>">
                            </div>

                            <div class="col-md-6">
                                <label for="url" class="form-label">url</label>
                                <input type="text" name="url" class="form-control" id="url"
                                    value="<?= $headerMenu['url'] ?>">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="parent_id" id="parent_id">
                                    ...
                                    <option value="<?= $menu['id'] ?>"
                                        <?= $headerMenu['parent_id'] == $menu['id'] ? 'selected' : '' ?>>
                                        <?= $menu['name'] ?>
                                    </option>
                                    <?php }
                                    } ?>
