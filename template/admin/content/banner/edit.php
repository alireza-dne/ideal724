            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش اصلاح بنر</h3>
                            <h6 class="mb-5"></h6>
                    ...
                    <div class="body-content">
                        <form class="row g-3" action="<?= url('admin/content/banner/update/' . $banner['id']) ?>"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="url" class="form-control" id="slug"
                                    value="<?= $banner['url'] ?>">
                            </div>
                            ...
                            <div class="mb-3 col-md-6"><img class="edit-image" src="<?= asset($banner['image']) ?>"
                                    alt="edit-image">
                            </div>
