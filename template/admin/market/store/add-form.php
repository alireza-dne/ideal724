            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش افزایش یا کاهش اطلاعات انبار محصول</h3>
                            <h6 class="mb-5"></h6>
                    ...
                    <div class="body-content">
                        <form class="row g-3" action="<?= url('admin/market/store/add/' . $product['id']) ?>"
                            method="post" enctype="multipart/form-data">


                            <div class="col-md-6">
                                <label for="marketable_number" class="form-label">افزایش یا کاهش موجودی انبار</label>
                                <input type="number" name="marketable_number" class="form-control"
                                    id="marketable_number" value="<?= old('marketable_number') ?>">
                            </div>

                            <div class="col-md-6">
                                <label for="sold_number" class="form-label">افزایش یا کاهش تعداد فروخته شده</label>
                                <input type="number" name="sold_number" class="form-control" id="sold_number"
