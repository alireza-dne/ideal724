            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش ایجاد کد تخفیف جدید</h3>
                            <h6 class="mb-5"></h6>
                        ...
                        <form class="row g-3" action="<?= url('admin/market/discount/store') ?>" method="post"
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="amount_type" id="amount_type">
                                    <option value="1" <?= old('amount_type') == 1 ? 'selected' : '' ?>>درصد (%)</option>
                                    <option value="2" <?= old('amount_type') == 2 ? 'selected' : '' ?>>تومان</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="type" id="type">
                                    ...
                                    <option value="2" <?= old('type') == 2 ? 'selected' : '' ?>>عمومی</option>
                                </select>
                            </div>
