            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bolder mb-1">بخش گالری محصول - <?= $product['name'] ?></h3>
                            <h6 class="mb-5">در این بخش اطلاعاتی در مورد دسته بندی محصولات به شما نمایش داده می شود</h6>
                        </div>

                        <div><a href="<?= url('admin/market/product/' . $product['id'] . '/gallery/create') ?>"
                            ...
                            <tbody>
                                <?php foreach ($galleries as $gallery) { ?>
                                    <tr class="ajax-delete">
                                        ...
                                        <td><img class="table-image" src="<?= asset($gallery['image']) ?>" alt="">
                                        </td>

                                        <td>
                                            <div>
                                                <button class="text-danger btn btn-sm btn-ajax-delete"
                                                    targetUrl="<?= url('admin/market/gallery/delete/' . $gallery['id']) ?>"><i
                                                        class="fas fa-trash"></i></button>

                                                <a href="<?= url('admin/market/gallery/edit/' . $gallery['id']) ?>"
