            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش اصلاح گالری محصول - <?= $product['name'] ?></h3>
                            <h6 class="mb-5"></h6>
                    ...
                    <div class="body-content">
                        <form class="row g-3" action="<?= url('admin/market/gallery/update/' . $gallery['id']) ?>"
                            ...
                            <div class="mb-3 col-md-6"><img class="edit-image" src="<?= asset($gallery['image']) ?>"
                                    alt="edit-image">
                            </div>
