            ...
            <div class="row mt-5 p-3">
                <div class="col-12 main-body-container bg-white p-3 rounded">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <h3 class="fw-bolder mb-1">بخش ایجاد مقادیر ویژگی محصول</h3>
                            <h6 class="mb-5"></h6>
                    ...
                    <div class="body-content">
                        <form class="row g-3"
                            action="<?= url("admin/market/category-attribute-value/$categoryAttributeID/store") ?>"
                            method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="type" id="type">
                                    <option value="1" <?= old('type') == 1 ? 'selected' : '' ?>>تکی</option>
                                    <option value="2" <?= old('type') == 2 ? 'selected' : '' ?>>چند گانه</option>
                                </select>
                            </div>
